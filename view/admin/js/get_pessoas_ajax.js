$(document).ready( function(){
	...
	function denovo(){
		$.ajax({
	      ...
	      method: 'post',
	      data: {registros_por_pagina: $('#registros_por_pagina').val(), offset: offset, opcao: 'pessoa_fisica'},
	   		}).done(function(retorno_requisicao){
	   			$('#tabela_pessoa_fisica').html(retorno_requisicao);
      ...
      $.ajax({
         url: "pesquisas/get_table.php",
         method: 'post',
         data: {registros_por_pagina: $('#registros_por_pagina').val(), offset: offset, opcao: 'pessoa_juridica'},
            }).done(function(retorno_requisicao){
               $('#tabela_pessoa_juridica').html(retorno_requisicao);
